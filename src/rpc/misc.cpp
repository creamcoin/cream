    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given cream address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The cream address to validate"},
                },
                RPCResult{
            "{\n"
            ...
            "}\n"
                ...
                RPCExamples{
                    HelpExampleCli("validateaddress", "\"CeuQBM8Dt2rJ1tEVevtGyZnEEKACbJm2Yk\"")
            + HelpExampleRpc("validateaddress", "\"CeuQBM8Dt2rJ1tEVevtGyZnEEKACbJm2Yk\"")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The cream address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"CeuQBM8Dt2rJ1tEVevtGyZnEEKACbJm2Yk\", \"signature\", \"my message\"")
                },
            }.ToString());
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "cream-cli and the GUI. There is no server-side difference.",
                {},
                RPCResults{},
                RPCExamples{""},
            }.ToString()
