    ...
    mapper(0)
{
    ...
    ui->creamAtStartup->setToolTip(ui->creamAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->creamAtStartup->setText(ui->creamAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->creamAtStartup, OptionsModel::StartAtStartup);
